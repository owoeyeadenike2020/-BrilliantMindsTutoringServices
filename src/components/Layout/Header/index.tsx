...
const Header: React.FC = () => {
  ...
  return (
    <header
      className={`fixed top-0 z-40 w-full pb-2 transition-all duration-300 bg-white ${sticky ? " shadow-lg py-2" : "shadow-none py-2"
        }`}
    >
        ...
        >
          <div className="flex items-center justify-between p-4">
            ...
            <button
              ...
              className="bg-[url('/images/closed.svg')] bg-no-repeat bg-white w-5 h-5 absolute text-black top-0 right-0 mr-8 mt-8 dark:invert"
